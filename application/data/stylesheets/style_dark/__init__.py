...
def load_stylesheet(pyside=True):
    ...
    if pyside:
        import data.stylesheets.style_dark.pyside_style_rc
    else:
        import data.stylesheets.style_dark.pyqt_style_rc
    ...
    f = QFile("data/stylesheets/style_dark/dark_style.qss")
    if not f.exists():
...
def load_stylesheet_pyqt5():
    ...
    """
    # Smart import of the rc file
    import data.stylesheets.style_dark.pyqt5_style_rc
